...
ADMINS = list(map(int, environ.get('ADMINS', '7285288195 5370676246').split()))  # List of admin user IDs
...
OWNER_USERNAME = environ.get("OWNER_USERNAME",BOT'gmovies270')  # Owner's username
